...
use base_execution_firehose::OpFirehoseEvmConfig;
...
impl<Node, Pool> PayloadServiceBuilder<Node, Pool, OpFirehoseEvmConfig<BaseEvmConfig>>
    for MultiplexingServiceBuilder
where
    Node: NodeBounds,
    Pool: PoolBounds + Clone,
{
    async fn spawn_payload_builder_service(
        ...
        pool: Pool,
        evm_config: OpFirehoseEvmConfig<BaseEvmConfig>,
